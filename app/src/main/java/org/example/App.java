...
public class App {
  public static void main(String[] args) {
    ...
    System.out.println("Number of Sides: " + r.numberOfSides());
    ...
    System.out.println("Number of Sides: " + t.numberOfSides());
    ...
    System.out.println("Number of Sides: " + it.numberOfSides());
